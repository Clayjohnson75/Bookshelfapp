-- ============================================================
-- BOOKSHELF SCANNER - Books Table Migration
-- ============================================================
-- Copy and paste this entire file into your Supabase SQL Editor
-- This creates the books table for tracking read status across devices
-- ============================================================
...
-- This ensures each user can only have one entry per book
...
-- Safely create trigger only if it doesn't exist (avoids warning about DROP statement)
DO $$ 
BEGIN
  IF NOT EXISTS (
...
-- ============================================================
-- Migration complete!
-- Your books table is now ready for cross-device sync
-- ============================================================
