...
function getStyles(t: ThemeTokens) {
 ...
 settingItem: { paddingVertical: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
 settingContent: { flex: 1, marginRight: 12 },
 settingHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 4 },
 settingLabel: { fontSize: 16, color: c.textPrimary ?? c.text, fontWeight: '600', marginBottom: 4 },
 settingDescription: { fontSize: 14, color: c.textSecondary ?? c.textMuted },
 ...
 saveButtonText: { color: c.primaryText, fontSize: 16, fontWeight: '700' },
 divider: { height: 1, backgroundColor: c.divider ?? c.border, marginVertical: 20 },
